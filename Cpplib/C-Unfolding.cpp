...
void Is0Boostrap(vector<double>& total_eigs, arg_list args, int num_conf, int num_resampling, vector<double>& Is0, vector<double>& err_Is0, vector<double>& array_bin){
...
int main(int argc, char** argv){
    ...
    Is0Boostrap(total_eigs, args, num_conf, args.num_resampling, Is0, err_Is0, array_bins);
